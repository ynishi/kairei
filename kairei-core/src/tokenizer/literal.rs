...
///
/// ```
/// # use kairei_core::tokenizer::literal::{parse_triple_quote_string, StringLiteral, StringPart, Literal};
...
///
/// ```
/// # use kairei_core::tokenizer::literal::{parse_single_quote_string, StringLiteral, StringPart, Literal};
/// let input = "\"Hello ${name}!\"";
...
///
/// ```
/// # use kairei_core::tokenizer::literal::{parse_interpolation, StringPart};
/// let input = "${name} rest";
...
///
/// ```
/// # use kairei_core::tokenizer::literal::{parse_float_literal, Literal};
/// let input = "3.14159";
...
///
/// ```
/// # use kairei_core::tokenizer::literal::{parse_integer_literal, Literal};
/// let input = "42";
...
///
/// ```
/// # use kairei_core::tokenizer::literal::{parse_boolean_literal, Literal};
/// let input = "true";
...
///
/// ```
/// # use kairei_core::tokenizer::literal::parse_literal;
/// # use kairei_core::tokenizer::token::Token;
/// # use kairei_core::tokenizer::literal::{Literal, StringLiteral, StringPart};
