...
///
/// ```
/// # use kairei_core::tokenizer::symbol::parse_operator;
/// # use kairei_core::tokenizer::token::Token;
/// # use kairei_core::tokenizer::symbol::Operator;
/// let input = "=> rest";
...
///
/// ```
/// # use kairei_core::tokenizer::symbol::parse_delimiter;
/// # use kairei_core::tokenizer::token::Token;
/// # use kairei_core::tokenizer::symbol::Delimiter;
/// let input = "{ code }";
