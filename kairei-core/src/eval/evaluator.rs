...
use crate::{
    Expression, HandlerBlock, event_registry::EventType, provider::types::ProviderError,
...
///
/// ```ignore
/// use kairei_core::eval::{Evaluator, ExecutionContext};
/// use kairei_core::HandlerBlock;
/// use std::sync::Arc;
///
...
impl Evaluator {
    ...
    ///
    /// ```ignore
    /// use kairei_core::Expression;
    /// use kairei_core::tokenizer::literal::Literal;
    /// use kairei_core::expression::Value;
    /// use kairei_core::eval::{Evaluator, ExecutionContext};
    /// use std::sync::Arc;
    ///
