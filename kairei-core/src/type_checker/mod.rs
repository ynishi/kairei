...
/// ## Core Components
/// ```rust
/// use kairei_core::type_checker::{TypeScope, TypeCheckError};
/// use kairei_core::type_checker::visitor::common::PluginVisitor;
/// use kairei_core::type_checker::visitor::DefaultVisitor;
///
...
/// ## Plugin System
/// ```rust
/// use kairei_core::ast::{Root, MicroAgentDef};
/// use kairei_core::type_checker::{TypeContext, TypeCheckResult};
///
