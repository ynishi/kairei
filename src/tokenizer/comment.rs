...
///
/// ```
/// # use kairei::tokenizer::comment::parse_line_comment;
/// # use kairei::tokenizer::token::{Token, CommentType};
...
///
/// ```
/// # use kairei::tokenizer::comment::parse_block_comment;
/// # use kairei::tokenizer::token::{Token, CommentType};
/// let input = "/* This is a\n block comment */code";
...
///
/// ```
/// # use kairei::tokenizer::comment::parse_line_documentation_comment;
/// # use kairei::tokenizer::token::{Token, CommentType};
...
///
/// ```
/// # use kairei::tokenizer::comment::parse_block_documentation_comment;
/// # use kairei::tokenizer::token::{Token, CommentType};
...
///
/// ```
/// # use kairei::tokenizer::comment::parse_comment;
/// # use kairei::tokenizer::token::{Token, CommentType};
/// let input = "// This is a comment\ncode";
